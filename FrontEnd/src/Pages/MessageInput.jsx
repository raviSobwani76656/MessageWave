  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="w-full max-w-3xl mx-auto p-4">
        ...
        >
          <div className="flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2 shadow-sm w-full">
            {/* Text Input */}
            <input
              value={messagetext}
          ...
          <button
            ...
            className={`min-w-[40px] h-10 flex items-center justify-center rounded-full transition-colors ${
